...
<table>
    <tr>
        ...
        <td>Theoretical_Power_Curve (KWh)</td>
        <td>Wind Direction (°)</td>
        <td>Rounded to the nearest even values of Theoretical_Power_Curve(KWh)</td>
        <td>LV ActivePower(kW)  * Wind Speed (m/s)</td>
        <td>Median of LV ActivePower (kW)</td>
        <td>Median of Theoretical_Power_Curve (KWh)</td>
        <td>Summation of the LV ActivePower (kW)</td>
        <td>Total Number of Data Available</td>
    </tr>
    <tr>
        <td>1/1/18 0:00</td>
        <td>380.0477905</td>
